	   ...
	   @return  (Date) the corrected date */
        ...
        _generateHTML: function (inst) {
            ...
            var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
                ...
                ' title="' + prevText + '">' + (isRTL ? '<i class="fa fa-arrow-circle-right"></i>' : '<i class="fa fa-arrow-circle-left"></i>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-prev btn btn-link ui-state-disabled" title="' + prevText + '">' + (isRTL ? '<i class="fa fa-arrow-circle-right"></i>' : '<i class="fa fa-arrow-circle-left"></i>') + '</a>'));
            ...
            var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
                ...
                ' title="' + nextText + '">' + (isRTL ? '<i class="fa fa-arrow-circle-left"></i>' : '<i class="fa fa-arrow-circle-right"></i>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-next btn btn-link ui-state-disabled" title="' + nextText + '">' + (isRTL ? '<i class="fa fa-arrow-circle-left"></i>' : '<i class="fa fa-arrow-circle-right"></i>') + '</a>'));
